...
///
/// This function does not take any arguments. It calls the `bindings::dovetail_start` function and checks the return value. If the return value is 0, it returns `Ok(0)`. Otherwise, it returns `Err(kernel::error::code::EINVAL)`.
///
