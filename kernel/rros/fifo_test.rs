...
use kernel::{c_str, cpumask::CpumaskT, prelude::*, new_spinlock, sync::SpinLock, sync::Arc};
...
pub fn test_rros_enqueue_fifo_thread() -> Result<usize> {
    ...
    unsafe {
        ...
        new_spinlock!(pinned_r2, "rtimer_2");
        ...
        new_spinlock!(pinned_r3, "rtimer_3");
